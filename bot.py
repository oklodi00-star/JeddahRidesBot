"""
🤖 بوت مشاوير جدة - النسخة النهائية المتكاملة (محدثة)
- إضافة قائمة ضخمة بأحياء جدة.
- كشف ذكي لأي موقع غير مدرج في القائمة.
"""
...
# ============================================================
# 📚 الكلمات والقوائم (تم تحديث المواقع بشكل ضخم)
# ============================================================
MONTHLY_TRIP_WORDS = [
...
# قائمة ضخمة بأحياء جدة (تمت إضافة القرينية وغيرها)
LOCATIONS_SET = {
    # المنطقة التاريخية والوسطى
    "البلد", "الحجاز", "الشرفيه", "المظلوم", "القريات", "الرويس", "السبيل",
    "العماريه", "الجامعه", "الثغر", "البغداديه", "الهنداويه", " الصحيفه",
    "الوزيريه", "القرينيه", "القرينية", "الكندره", "بنى مالك", "بني مالك",
    # الشرق
    "النسيم", "النعيم", "الصفا", "المروه", "السالميه", "الفيصليه", "الرحاب",
    "البوادي", "المحمديه", "الحمدانيه", "الخالديه", "الزهراء", "السلامه",
    "النزهه", "الواحه", "الربوه", "الروضه", "الفيحاء", "السامر", "الاجواد",
    "التوفيق", "العدل", "المنار", "الريان", "الوادي", "الفلاح", "النهضه",
    "الرابيه", "السلام", "المرجان", "الصالحيه", "المشرفه", "بني مالك",
    # الشمال
    "الحرازات الشمالية", "الحرازات الجنوبية", "الحرازات", "الاندلس", "الاندلس مول",
    "الفضيله", "الرغامه", "الخمره", "السنابل", "التيسير", "تيسير", "ابحر",
    "الشاطئ", "الكورنيش", "الصاله", "الزهراء", "النخيل", "الجامعه",
    "الحمراء", "المروه", "الصفا", "الروضه", "الربوه", "النزهه", "المشرفه",
    "الخالديه", "النعيم", "السلامه", "التوفيق", "العدل", "المنار",
    "الواحه", "الفيصليه", "الريان", "الوادي", "الفلاح", "النهضه",
    "الرابيه", "السلام", "المرجان", "الفيحاء", "الصناعيه", "الزهراء",
    "أبحر", "ابحر", "الشماليه", "الشرقيه", "الجنوبيه", "الغربيه",
    "مكه", "جده",
}
...
class SmartRidesBot:
    ...
    def detect_presence(self, text):
        ...
        # 3. الالتقاط الذكي لأي موقع ملتصق بـ "بال" أو "ب" (حل مشكلة القرينية)

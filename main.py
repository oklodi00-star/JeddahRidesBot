...
بعد كم دقيقة من الهدوء يرسل البوت رسالة؟
...
async def handle_single_trip_word(
message,
text
):
...
try:  
    ...
    # الرسالة التالية نوع مختلف  
    idle_turn = (  
        idle_turn + 1  
    ) % 3  

    # مهم جدًا:  
    # يبدأ عداد 30 دقيقة من جديد  
    last_activity = now  
...
# أي رسالة حقيقية تعيد مؤقت الهدوء للصفر  

...
CHAT_RESPONSES = [
    ...
    (
        ...
        [
            ...
            "مرة عميل قال للكابتن: توصني بسرعة\nالكابتن قال: طيب امسك نفسك 😂",
        ]
    ),
    (
        ["مزح", "امزح", "مزحة", "تمزح"],
        ["أنا ما أمزح... أنا جاد في المشاوير 😎😂", "المزح حلو بس المشاوير أحلى 🚘", "أنا أمزح بس إذا طلبت مشوار أكون جاد جداً 🫡😂"]
    ),
    (
        ["شسمك", "اسمك", "من انت"],
        ["اسمي بوت المشاوير 😎\nوأنت اسمك عميل المستقبل 🚘", "أنا صديقك الإلكتروني 🤖\nواسمي: جاهز لأي مشوار 🚕", "اسمي سري...\nبس تقدر تناديني: يا بوت المشاوير 😂"]
    ),
    (
        ["ولد", "بنت", "ذكر", "انثى"],
    ...
    (
        ["اهلك", "وين اهلك", "عائلتك"],
        ["أهلي الكباتن والعملاء 🚕❤️", "عائلتي كل أعضاء القروب 🫶"]
    ),
    (
        ["بيتك", "وين بيتك", "ساكن فين"],
        ["بيتي في قلوب العملاء ❤️😂", "ساكن في القروب... الإيجار مجاني 😎", "بيتي في السحابة... أقصد السيرفر 😂"]
    ),
    (
        ["سيارتك", "عندك سيارة", "وش سيارتك"],
        ["سيارتي: كيبورد وماوس 😂", "عندي سيارة... اسمها الإنترنت 🚘", "سيارتي أسرع من الكباتن... لأني إلكتروني ⚡😂"]
    ),
    (
        ["مطوع", "شيخ", "عالم"],
        ["أنا شيخ المشاوير 😎😂", "أنا عالم في توصيل العملاء 🚕"]
    ),
    (
        ["دكتور", "مهندس", "مدرس"],
        ["أنا دكتور مشاوير 😂", "أنا مهندس توصيل 🚘", "أنا مدرس: كيف تطلب مشوار صح 😎"]
    ),
    (
        ["غني", "فقير", "فلوسك"],
    ...
    (
        ["جوعان", "اكل", "مطعم", "غدا", "عشاء", "فطور"],
        ["جوعان؟ اطلب مشوار لأقرب مطعم 😂🚘", "أنا جوعان لمشاوير... اطلب وأنا أشبع 😎", "الأكل حلو... بس المشوار قبل الأكل أحلى 🚕"]
    ),
    (
        ["شاي", "قهوة", "عصير", "موية"],
        ["أنا أشرب كهرباء ⚡😂\nبس أنت اطلب مشوار وخذ لك قهوة 🚘", "شاي أخضر مع مشوار = يوم كامل 😎"]
    ),
    (
        ["طقس", "حر", "برد", "مطر", "شمس"],
        ["الحر ما يهم... الكابتن عنده مكيف 🚕❄️", "المطر حلو... بس المشوار أحلى 😂", "الطقس اليوم: مشاوير جزئية 🚘😎"]
    ),
    (
        ["وقت", "ساعة", "تأخر", "بدري"],
        ["الوقت عندنا: وقت مشوار 😂", "بدري ولا متأخر... الكباتن جاهزين 🚕"]
    ),
    (
        ["عندك وقت", "فضى", "فاضي"],
        ["فاضي لمشاويركم 🚘", "عندي وقت... كله لخدمتكم 🌹"]
    ),
    (
        ["تضحك", "ضحك", "ضحكتك"],
        ["ضحكتي إلكترونية: هاهاهاها 😂", "أضحك لما أشوف مشوار ناجح 🚘"]
    ),
    (
        ["غني", "غنوة", "اغنية"],
        ["🎵 مشوار... مشوار... من الفضيلة للرغامة 🎵\nهذي أغنيتي المفضلة 😂", "أغنية: جاهز يا عميل 🚕"]
    ),
    (
        ["رقص", "ارقص", "رقصة"],
        ["أرقص لما يجي مشوار جديد 😂💃", "رقصتي: من الحمدانية للرغامة 🚘"]
    ),
    (
        ["هدية", "هديه", "اعطيني"],
        ["هديتي لك: أسرع كابتن في جدة 🚕", "أعطيك مشوار مجاني... أمزح 😂"]
    ),
    (
        ["قروب", "المجموعه", "القروب"],
        ["القروب هذا عائلتي الثانية ❤️", "أحلى قروب مشاوير في جدة 🚘"]
    ),
    (
        ["كلام", "سالفه", "سالفة", "حكايه"],
        ["أحب السوالف... بس المشاوير أحلى 😂", "عندك سالفة؟ أنا أسمع 🫡"]
    ),
    (
        ["شاطر", "ذكي", "فنان", "مبدع"],
        ["شاطر في المشاوير 😎", "أذكى بوت مشاوير في جدة 🚘", "فنان في توصيل العملاء 🚕"]
    ),
    (
        ["سيء", "زفت", "فاشل", "غبي"],
        ["آسف إذا قصرت 🌹\nعلمني وش تبي", "أنا أتعلم... جربني بمشوار 😅", "لا تحكم علي... اطلب مشوار وشوف 😎"]
    ),
    (
        ["ملل", "طفش", "طفشان", "زهقان"],
        ["طفشان؟ اطلب مشوار وتروق 🚘", "الملل يروح مع المشاوير 😎", "أنا عندي حل للملل: مشوار + كابتن محترم 🚕"]
    ),
    (
    ...
    (
        ["سوق", "مشتريات", "بقاله", "بقالة"],
        ["تبي السوق؟ الكابتن جاهز 🚕", "مشترياتك توصل معنا 🚘"]
    ),
    (
        ["مستشفى", "مستشفي", "دكتور", "موعد"],
    ...
    (
        ["شباب", "يا شباب", "جماعه", "جماعة"],
        ["أنا معاكم 🫡", "حاضرين للطيبين 🌹"]
    ),
    (
        ["ان شاء الله", "ان شاءالله", "باذن الله"],
        ["إن شاء الله 🌹", "الله يوفق 🤲"]
    ),
    (
        ["الحمدلله", "الحمد لله", "سبحان الله", "الله اكبر"],
        ["الحمدلله على كل حال ❤️", "الله يوفقك 🌹"]
    ),
    (
        ["يا رب", "يارب", "اللهم"],
        ["آمين 🤲", "الله يوفق الجميع 🌹"]
    ),
    (
        ["فديتك", "فداك", "روحي"],
